...
// without ` and ] to workaround Rule 17 (inline code blocks/links)
    ...
    //console.log(inline.em);
    inline.sup = edit(inline.sup).replace(/punctuation/g, inline._punctuation).getRegex();
    //console.log(inline.sup);
    inline.sub = edit(inline.sub).replace(/punctuation/g, inline._punctuation).getRegex();
...
// no need for block level renderers
    ...
    Parser.prototype.tok = function() {
        switch (this.token.type) {
            ...
            case 'sup': {
                return this.renderer.sup(this.parseText());
            }
            case 'sub': {
                return this.renderer.sub(this.parseText());
            }
            default: {
